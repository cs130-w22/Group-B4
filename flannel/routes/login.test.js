...
const userThree = { //we are going to delete this user every time and dummy log it in 
    "username": "test3@g.ucla.edu",
    "password": "1234",
    "token": "",
}

const userFour = { //we are going to delete this user every time and dummy log it in 
