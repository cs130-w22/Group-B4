        ...
        <Box sx = {styles.root}>
            ...
            <form onSubmit = {handleFormSubmit}>
                <Box sx = {styles.formContainer}>
                    ...
                    <Box sx = {styles.formColumn}>
                        <TextField label = "Hometown" defaultValue = {user.hometown} style = {{padding:"10px"}} id = "hometown"/>                 
            ...
            <Button fullWidth variant = "contained" color = "success" type="submit">Update Info</Button>
            </form>
        </Box>
    )
}